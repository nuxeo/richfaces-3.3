...
public class BeanELResolver extends ELResolver {
    ...
    private boolean isReadOnly;
     ...
     private static final Map<Class, BeanProperties> properties =
         Collections.synchronizedMap(new LinkedHashMap(CACHE_INIT_SIZE, 0.75f, true){
            public BeanProperties put(Class key, BeanProperties value) {
                 SoftReference<BeanProperties> ref = new SoftReference(value);
             ...
             public BeanProperties get(Class key) {
